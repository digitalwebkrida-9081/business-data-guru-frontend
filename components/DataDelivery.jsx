    ...
    <section className="py-20 pt-0 bg-white">
      <div className="max-w-7xl mx-auto px-6 flex flex-col-reverse lg:flex-row items-center gap-14">
        ...
        <div className="flex-1 max-w-xl">
          ...
          <p className="mt-5 text-[#425466] text-base leading-relaxed">
            Business Data Guru scrapes and transforms data into your preferred
            structure and format, including TXT, PDF, Image, JSON, FTP, API, and
            CSV, streamlining integration with your business processes.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col-reverse lg:flex-row items-center gap-14 pt-10">
        ...
        <div className="flex-1 max-w-xl">
          ...
          <p className="mt-5 text-[#425466] text-base leading-relaxed">
            We ensure smooth, secure data delivery to any specified location,
            upholding the highest standards of data confidentiality and
            integrity.
          </p>
