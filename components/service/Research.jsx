  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/images/service-page/research-hero.jpg')`,
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-200 text-lg mb-8 leading-relaxed">
              Business Data Guru knows that researchers and journalists need
              good data to make their analysis and reports better. We aim to
              help you get the Research and Journalism data like weather trends,
              indicators for third world development, crime stats, along with
              local as well as worldwide tendencies. This will fuel your next
              research project or news story (Business Data Guru.com).
            </p>
        ...
        <div className="hidden lg:block absolute top-1/2 right-60 transform -translate-y-1/2 w-120 rounded-lg p-4  shadow-2xl">
          <img
            src="/images/service-page/research-vector.png"
            alt="Research Data Scraping"
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-[#EBF3FF]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Elevating Your Research with Business Data Guru
          </h2>
          <p className="max-w-4xl mx-auto text-gray-600 mb-16 leading-relaxed">
            The quality of data is what supports any research project. Our team
            from Business Data Guru can scrape social media sites to find out
            what are the most popular news topics at present, get data for
            backing up arguments and claims in your stories, gather information
            to create interesting infographics and many other things. We provide
            you with reliable Research and Journalism data that allows accurate
            analysis.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Business Data Guru is a service that offers many types of data
              from different origins. These can be publications, crime numbers,
              social media details or thoughts from crowds; it could also
              include weather facts and history records for use in Research and
              Journalism. We use the newest methods to give you structured data
              which is correct and current according to your requirements.
            </p>
            ...
            <div className="grid grid-cols-2 gap-8 text-center mt-10">
              <DataPoint
                ...
                title="Weather data"
                desc="Observe the weather of specific places and draw insights about the climate based on the same data."
              />
              <DataPoint
                icon={
                ...
                desc="Make reports and write research articles by getting development data of various developing countries."
              />
              <DataPoint
                icon={
                  <FaShieldAlt className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Crime & Legal data"
                desc="Support your research with statistical data, historical records, court cases data & more from law enforcement agencies."
              />
              <DataPoint
                icon={
                ...
                desc="Recognize trends using social media and newspaper data. Get insights from social websites such as Facebook, Instagram, Twitter, Linked In, Reddit."
              />
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="/images/service-page/research-1.png"
              alt="Research Data Scraping"
      ...
      <section className="bg-[#2F66F6] py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="mb-10 text-left max-w-5xl leading-relaxed text-blue-100 text-[18px]">
            Business Data Guru is a complete provider, supplying special,
            instantaneous and personalized Research and Journalism data as per
            your demands. The data we scrape is only for you which helps to make
            sure that no one else has it, giving a competitive advantage over
            those who use generic or already present datasets.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-medium">
            ...
            <div className="col-span-2 relative">
              <img
                src="/images/service-page/research-2.png"
                alt="Dashboard"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-12 text-center text-gray-500 text-lg">
            The web has a lot of data that is very important for research, and
            Business Data Guru can assist you in using it well. We are able to
            scrape big data from all different kinds of places on the internet
            and organize them into structures so that our customers always have
            the most recent news and useful information they need available in
