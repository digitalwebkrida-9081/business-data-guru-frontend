  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/images/service-page/recruit-hero.png')`,
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-200 text-lg mb-8 leading-relaxed">
              At Business Data Guru, we offer tailored data scraping solutions
              to extract job data from various recruitment-related sources
              across the web. Our services enable you to scrape job data,
              including the latest job listings, open vacancies, candidate
              profiles, company profiles, in-demand skills, and hiring locations
              from career pages of company websites and job portals. With our
              help, you can build reliable job data feeds to fuel your
              recruitment efforts.
            </p>
        ...
        <div className="hidden lg:block absolute top-1/2 right-60 transform -translate-y-1/2 w-120 rounded-lg p-4  shadow-2xl">
          <img
            src="/images/service-page/recruit-vector.png"
            alt="Recruitment Data Scraping"
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-[#EBF3FF]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="max-w-4xl mx-auto text-gray-600 mb-16 leading-relaxed">
            Our accurate data pool can supercharge your CRM and accelerate your
            business growth. By monitoring jobs, companies, reviews, candidates,
            profiles, and resumes, you can stay ahead of your competitors.
            Scraping job listing websites allows you to aggregate jobs and keep
            your job portal updated with the latest data.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Business Data Guru provides job monitoring data, including job
              listings, candidates seeking opportunities, resumes, professionals
              with specific skills, company reviews, salary trends, job
              responsibilities, and more. Our cutting-edge technologies allow us
              to serve web data tailored to your exact requirements.
            </p>
            ...
            <div className="grid grid-cols-2 gap-8 text-center mt-10">
              <DataPoint
                ...
                desc="Obtain the latest job listings data to stay updated on new vacancies. Enhance your job board's quality and organize aggregated data for effective use."
              />
              <DataPoint
                icon={
                  <FaHandHoldingUsd className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Most searched location data"
                desc="Set up an analytical system to identify when and where new jobs are posted to optimize the process of lead generation."
              />
              <DataPoint
                icon={
                ...
                desc="Access a vast pool of candidate resumes to ensure your business attracts the best talent. Feed your recruitment management portal with thousands of resumes for more efficient sourcing."
              />
              <DataPoint
                icon={
                ...
                desc="Source the best talent by knowing what the market needs. Talk to a greater number of candidates with specific skills and reach the right group of candidates for the right hiring."
              />
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="/images/service-page/recruit-1.png"
              alt="Recruitment Data Scraping"
      ...
      <section className="bg-[#2F66F6] py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="mb-10 text-left max-w-5xl leading-relaxed text-blue-100 text-[18px]">
            Business Data Guru is a full-service provider, offering unique,
            real-time, and custom data based on your precise business
            requirements. Scraped recruitment data from Business Data Guru will
            never be the same as the data your competitors purchase from
            existing providers. We deliver unique and updated data you can
            trust.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-medium">
            ...
            <div className="col-span-2 relative">
              <img
                src="/images/service-page/recruit-2.png"
                alt="Dashboard"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-12 text-center text-gray-500 text-lg">
            E-commerce data scraping is a game-changer for businesses looking to
            expand their brand. Leverage data-driven insights to make informed
            decisions about products, ensuring alignment with your target
            audience. As your business scales, reliable data becomes crucial.
            Business Data Guru empowers data-driven E-commerce companies to
            measure and refine their strategies, enabling them to thrive in the
