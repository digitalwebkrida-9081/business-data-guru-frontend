  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/images/service-page/retail-hero.png')`,
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-200 text-lg mb-8 leading-relaxed">
              Take your business higher with precise, confirmed, refreshed,
              cost-effective and Retail Store Location Data available instantly.
              Experience matchless understanding of the retail market through
              wide-ranging location intelligence that covers data about store
              openings and closings, ease of parking, choices for in-store
              pickup along with services provided by subsidiaries as well as
              nearest competitors' locations.
            </p>
        ...
        <div className="hidden lg:block absolute top-1/2 right-60 transform -translate-y-1/2 w-120 rounded-lg p-4  shadow-2xl">
          <img
            src="/images/service-page/retail-vector.png"
            alt="Retail Data Scraping"
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-[#EBF3FF]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Elevating Your Business with Business Data Guru
          </h2>
          <p className="max-w-4xl mx-auto text-gray-600 mb-16 leading-relaxed">
            Business Data Guru equips you with thousands of scraped retail store
            locations. This knowledge gives deep insights into new trends,
            competing prices and unlimited location data from multiple sources.
            With the most recent customer preferences in hand, retailers can
            plan their advertisements, promotions and sales campaigns
            effectively.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Media monitoring from Business Data Guru provides you with
              wide-ranging information access on particular subjects. We scrape
              social media platforms, podcasts, public newsletters, online news
              sites and blogs. You can specify exact news sources to monitor by
              location or industry and receive the data in your preferred
              customized format.
            </p>
            ...
            <div className="grid grid-cols-2 gap-8 text-center mt-10">
              <DataPoint
                ...
                desc="Extract store locations from website maps and generate valuable business leads in spreadsheet format."
              />
              <DataPoint
                icon={
                  <FaHandHoldingUsd className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Data Feed Monitoring"
                desc="Scrape worldwide news cost-effectively, showing real-time news and feature articles on your website according to the subjects you have chosen."
              />
              <DataPoint
                icon={
                ...
                desc="Get precise geographical information like longitudes, latitudes, Postal codes, city, number of stores, and other data."
              />
              <DataPoint
                icon={
                  <FaChartPie className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Large data feedsServices provided"
                desc="Get data for amenities and services provided in every outlet."
              />
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="/images/service-page/retail-1.png"
              alt="Retail Data Scraping"
      ...
      <section className="bg-[#2F66F6] py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="mb-10 text-left max-w-5xl leading-relaxed text-blue-100 text-[18px]">
            Business Data Guru is a full-service provider that gives you fresh
            and special data, made only for your particular business needs. The
            retail location data we scrape will always be different than the
            generic kind of information which other providers sell to your
            competition. You can trust in us to provide unique and current
            details.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-medium">
            ...
            <div className="col-span-2 relative">
              <img
                src="/images/service-page/retail-2.png"
                alt="Dashboard"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Business Data Guru: Your Trusted Partner in Unique, Real-time, and
            Custom Data
          </h2>
          ...
          <p className="mt-12 text-center text-gray-500 text-lg">
            Data has a very important part in promoting growth, progress and
            creativity within your company. Get the business locations that you
            require for allocation or selling. Business Data Guru is an expert
            at store location extraction projects, where we scrape store details
