  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/images/service-page/newsmoni-hero.png')`,
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-200 text-lg mb-8 leading-relaxed">
              Be updated with the most recent events by using our cutting-edge
              web scraping technologies to extract news data regarding
              companies, products, industries and suchlike. You can get
              worldwide data along with visualizations, infographics, trends and
              local news. News cycles and other types of data are also included
              that you may require for monitoring or evaluating any recent event
              worldwide trend or insight.
            </p>
        ...
        <div className="hidden lg:block absolute top-1/2 right-60 transform -translate-y-1/2 w-120 rounded-lg p-4  shadow-2xl">
          <img
            src="/images/service-page/newsmoni-vector.png"
            alt="News Monitoring Data Scraping"
          />
        </div>
      </section>
      ...
      <section className="py-20 bg-[#EBF3FF]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="max-w-4xl mx-auto text-gray-600 mb-16 leading-relaxed">
            Business Data Guru Labs is the place where we give you a lot of
            information that helps in monitoring and tracking subjects with
            accuracy and speed. Our services deliver trustworthy and precise
            data from websites, blogs, social media platforms like Facebook or
            Instagram, news sites such as BBC News online etc., review sites
            (like Yelp), and many other sources.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Business Data Guru Labs gives full media monitoring services,
              giving you a wider range of information related to your chosen
              topic. We can scrape social media platforms, podcasts, publicly
              available newsletters and online news sites plus blogs and forums
              among other places. We have the ability to focus on specific news
              sources for monitoring either by geographical location or industry
              sector. The data will be provided in any format that suits your
              needs best.
            </p>
            ...
            <div className="grid grid-cols-2 gap-8 text-center mt-10">
              <DataPoint
                ...
                desc="Obtain the latest job listings data to stay updated on new vacancies. Enhance your job board's quality and organize aggregated data for effective use.Watch over comments, news talks, evaluations of products and brands to comprehend the general way customers think."
              />
              <DataPoint
                icon={
                ...
                title="News data"
                desc="Scrape data from across the globe's news scene in a cost-effective manner. Present current news and feature articles on your website, emphasizing the topics you prefer."
              />
              <DataPoint
                icon={
                  <FaShieldAlt className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Public profiles data"
                desc="Share the voice and influence of top public profiles within your business niche."
              />
              <DataPoint
                icon={
                  <FaChartPie className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Large data feeds"
                desc="Monitor public relations and extensive data feed to improve media coverage and media relations.Get data feeds such as Hashtag analytics, campaign analytics, market research, etc."
              />
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="/images/service-page/newsmoni-1.png"
              alt="News Monitoring Data Scraping"
      ...
      <section className="bg-[#2F66F6] py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="mb-10 text-left max-w-5xl leading-relaxed text-blue-100 text-[18px]">
            Business Data Guru Labs is a complete provider, giving you
            exclusive, real-time and custom data that matches exactly with what
            your business needs. The scraped news monitoring data we provide is
            specific to only one user like yourself - it's different from the
            stuff other providers sell to your competition. Trust in our unique
            and current information for all of your business requirements.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-medium">
            ...
            <div className="col-span-2 relative">
              <img
                src="/images/service-page/newsmoni-2.png"
                alt="Dashboard"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-12 text-center text-gray-500 text-lg">
            Understand how the public views your brand, company, PR, market
            campaigns, news, products and services by using our news and media
            monitoring services. We keep an eye on all kinds of media sources
            and deliver to you each piece of information talking about your
            chosen topics - commercial/non-commercial or scientific in nature.
            <br />
            <br />
