  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/images/service-page/sales-hero.jpg')`,
        }}
      >
        {/* Overlay */}
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-200 text-lg mb-8 leading-relaxed">
              Refine your targeting accuracy by procuring relevant leads from
              the wide internet world. Communicate with perfect audience for
              product/service promotion or sales campaign execution smoothly.
              Enrich CRM data with emails, contact numbers, addresses, revenue
              figures, social media profiles and more. <br /> <br />
              START YOUR JOURNEY WITH Business Data Guru TODAY
            </p>
      ...
      <section className="py-20 bg-[#EBF3FF]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="max-w-4xl mx-auto text-gray-600 mb-16 leading-relaxed">
            Business Data Guru provides sales lead data that is current and of
            high quality, saving you time and resources. You can get detailed
            information like postal codes, first names and last names, LinkedIn
            URLs and more from us. The sales lead generation data assists you in
            finding prospective customers who are prepared to purchase your
            product or service. We empower companies to maximize resource
            utilization by providing rich and predictive details.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              We get information from business directories, listings, social
              media, online classifieds and reviews. We also have data about
              employees collected from job portals and many other sources that
              we can adjust to fit your needs. We use the latest technologies
              for gathering sales data which is the most prominent and
            ...
            <div className="grid grid-cols-2 gap-8 text-center mt-10">
              <DataPoint
                ...
                title="Tap into Business Listings"
                desc="Obtain data from business listings such as Yellow Pages and Yelp, use this for B2B marketing of your products and create important leads."
              />
              <DataPoint
                icon={
                ...
                desc="Monitor your competitors' reviews to understand consumer preferences and leverage them for targeted marketing."
              />
              <DataPoint
                icon={
                  <FaShieldAlt className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Access Employee Data"
                desc="Obtain high-level employee contact data through multi-level data gathering and refinement processes."
              />
              <DataPoint
                icon={
                  <FaChartPie className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Leverage Social Media Insights"
                desc="Identify prominent customers by tracking hashtags on platforms like Facebook, Instagram, and Twitter."
              />
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="/images/service-page/sales-1.png"
      ...
      <section className="bg-[#2F66F6] py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="mb-10 text-left max-w-5xl leading-relaxed text-blue-100 text-[18px]">
            Business Data Guru is the complete provider, presenting unique,
            on-demand and tailored data as per your business requirements. Only
            you get the scraped sales lead generation data, making you distinct
            from rivals who use general data providers. We bring fresh and
            different information for you to rely on.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-medium">
            ...
            <div className="col-span-2 relative">
              <img
                src="/images/service-page/sales-2.png"
                alt="Dashboard"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mt-12 text-center text-gray-500 text-lg">
            Precise data helps you connect with your intended viewers. Clever
            data supports unique pitching, giving a human touch to your sales
            style. Data scraping can bring numerous leads quickly in no time.
            Our scraping solutions are adjustable to fit your needs, you can
            configure them as per your requirements and modify later on.
            <br />
            <br />
