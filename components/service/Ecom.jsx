        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full text-white">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6">
              Unlock E-commerce Success with Business Data Guru
            </h1>
            <p className="text-gray-200 text-lg mb-8 leading-relaxed">
              Business Data Guru offers powerful E-commerce data scraping
              services to extract valuable insights from any website. Scrape
              E-commerce data such as product details, pricing, deals, customer
              reviews, ratings, and seller information. Make data-driven
              decisions to optimize your product offerings and understand your
              target audience.
            </p>
      ...
      <section className="py-20 bg-[#EBF3FF]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Empower Your Business with Business Data Guru
          </h2>
          <p className="max-w-4xl mx-auto text-gray-600 mb-16 leading-relaxed">
            Business Data Guru delivers high-quality, actionable E-commerce data
            to drive your online success. We provide comprehensive data,
            including product descriptions, bestsellers, images, demand trends,
            stock availability, and more from diverse sources. Gain access to
            structured, reliable data to expand your reach and dominate global
            markets.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Business Data Guru uses cutting-edge technologies to gather a
              wealth of E-commerce data, empowering you to outperform
              competitors. From product images and descriptions to performance
              metrics, variations, and stock availability, our data solutions
            ...
            <div className="grid grid-cols-2 gap-8 text-center mt-10">
              <DataPoint
                ...
                desc="Track demand for E-commerce products, top-ranking products, product specifications, seller details, shipping information, and more"
              />
              <DataPoint
                icon={
                  <FaHandHoldingUsd className="text-3xl text-gray-700 mx-auto mb-3" />
                }
                title="Customer’s Review & Ratings"
                desc="Scrape data for customer reviews and ratings from different sites to understand customer’s tastes and preferences."
              />
              <DataPoint
                icon={
                ...
                desc="Discover the items of different sellers and evaluate what items can offer the most reliable revenue-generating perspective."
              />
              <DataPoint
                icon={
                ...
                desc="Accurate and structured data ensure adequate product supply in the market. Pricing history and stock availability help in optimizing the product index."
              />
            </div>
          </div>
          ...
          <div className="relative">
            <img
              src="/images/service-page/ecom-1.png"
              alt="Ecom Solutions"
      ...
      <section className="bg-[#2F66F6] py-20 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="mb-10 text-left max-w-5xl leading-relaxed text-blue-100 text-[18px]">
            Ensure a seamless supply chain with accurate data on pricing and
            stock availability. Business Data Guru delivers unique, real-time,
            and customized data solutions tailored to your specific needs. Our
            exclusive, up-to-date insights give you a competitive edge.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm font-medium">
            ...
            <div className="col-span-2 relative">
              <img
                src="/images/service-page/ecom-2.png"
                alt="Dashboard"
