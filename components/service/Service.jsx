...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      className:
        "flex-col-reverse items-center border border-indigo-200 border-t-8 border-t-indigo-500",
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p className="text-gray-300 max-w-xl text-sm leading-relaxed mb-8">
              ...
              fingertips with Business Data Guru, your trusted web scraping
              solution provider.
            </p>
      ...
      <section className="relative bg-[#2F66F6] py-24 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Scale up your business with Business Data Guru
          </h2>
