  ...
  return (
    <footer className="bg-[#2F66F6] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-blue-50 leading-relaxed">
            Business Data Guru is a web scraping service company that extracts
            any relevant website and helps you get data for all your business
      ...
      <div className="border-t border-blue-300/40 py-4 text-center text-sm text-blue-50">
        © Business Data Guru 2014–2026 All Rights Reserved
      </div>
    </footer>
  );
}
