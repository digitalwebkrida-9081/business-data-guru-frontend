...
export const metadata: Metadata = {
  title: "Web Scraping & Data Extraction Services | Business Data Guru",
  description:
    "Business Data Guru provides professional web scraping and data extraction services. Convert website data into Excel, CSV, or JSON formats for research, business intelligence, and automation.",
  icons: {
